...
{
    // Toggle key by passing args to parseOptions, as if this were being run on the command line
...
void turnOn(const char * _key, const char * _nameMatch)
{
    // Turn on key by passing args to parseOptions, as if this were being run on the command line
    // _key should be "num", "caps", or "scroll"
    // _nameMatch is a string representing the keyboard type to match against (i.e. "MasterKeys*"
...
void turnOff(const char * _key, const char * _nameMatch)
{
    // Turn off key by passing args to parseOptions, as if this were being run on the command line
    // _key should be "num", "caps", or "scroll"
    // _nameMatch is a string representing the keyboard type to match against (i.e. "MasterKeys*"
